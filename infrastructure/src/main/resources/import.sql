...
INSERT INTO TRANSFER_SLIP (ID, AMOUNT, BENEFICIARY_INFORMATION, EXECUTION_DATE, ISSUER_ACCOUNT, LABEL, RECEIVER_ACCOUNT, REFERENCE, VERSION) VALUES ('323e4567-e90b-42d3-a456-556642440000', 2354.42, TRUE, '2020-12-11', 'cptref0007', 'virement pour anniversaire', 'cptref0008', 'bordereau transfert test', 0);
INSERT INTO TRANSFER_SLIP (ID, AMOUNT, BENEFICIARY_INFORMATION, EXECUTION_DATE, ISSUER_ACCOUNT, LABEL, RECEIVER_ACCOUNT, REFERENCE, VERSION) VALUES ('323e4567-e90b-42d3-a466-556642440000', 1550.53, TRUE, '2020-11-20', 'cptref0001', 'virement pour anniversaire', 'cptref0002', 'bordereau virement 0001', 0);
