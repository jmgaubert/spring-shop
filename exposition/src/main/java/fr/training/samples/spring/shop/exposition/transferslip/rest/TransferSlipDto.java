...
public class TransferSlipDto implements Serializable {
     ...
     */
    public TransferSlipDto(String id, String reference, String issuerAccount, String receiverAccount, LocalDate executionDate, double amount, String label, boolean beneficiaryInformation) {
        this.id = id;
